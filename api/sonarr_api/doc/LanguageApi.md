...
------------- | ------------- | -------------
[**apiV3LanguageGet**](LanguageApi.md#apiv3languageget) | **GET** /api/v3/language | 
[**apiV3LanguageIdGet**](LanguageApi.md#apiv3languageidget) | **GET** /api/v3/language/{id} | 
...
final api = SonarrApi().getLanguageApi();
...
# **apiV3LanguageIdGet**
> LanguageResource apiV3LanguageIdGet(id)
