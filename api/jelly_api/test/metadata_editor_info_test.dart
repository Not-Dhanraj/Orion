...
// tests for MetadataEditorInfo
void main() {
  final MetadataEditorInfo? instance = /* MetadataEditorInfo(...) */ null;
  // TODO add properties to the entity

  group(MetadataEditorInfo, () {
    // Gets or sets the parental rating options.
    // List<ParentalRating> parentalRatingOptions
    test('to test the property `parentalRatingOptions`', () async {
      // TODO
    });
    ...
    test('to test the property `cultures`', () async {
      // TODO
    });

    // Gets or sets the external id infos.
    // List<ExternalIdInfo> externalIdInfos
    test('to test the property `externalIdInfos`', () async {
      // TODO
    });
    ...
    test('to test the property `contentTypeOptions`', () async {
      // TODO
    });
