...
class PluginInstallationCompletedMessage {
  ...
  final SessionMessageType? messageType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PluginInstallationCompletedMessage &&
      other.data == data &&
  ...
  factory PluginInstallationCompletedMessage.fromJson(Map<String, dynamic> json) => _$PluginInstallationCompletedMessageFromJson(json);

  Map<String, dynamic> toJson() => _$PluginInstallationCompletedMessageToJson(this);
