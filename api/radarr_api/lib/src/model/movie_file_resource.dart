...
import 'package:radarr/src/model/media_info_resource.dart';
...
/// * [qualityCutoffNotMet]
@BuiltValue()
abstract class MovieFileResource
    implements Built<MovieFileResource, MovieFileResourceBuilder> {
  ...
  @BuiltValueField(wireName: r'originalFilePath')
  ...
  factory MovieFileResource([void updates(MovieFileResourceBuilder b)]) =
      _$MovieFileResource;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MovieFileResourceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MovieFileResource> get serializer =>
      _$MovieFileResourceSerializer();
}

class _$MovieFileResourceSerializer
    implements PrimitiveSerializer<MovieFileResource> {
  @override
  final Iterable<Type> types = const [MovieFileResource, _$MovieFileResource];

  @override
  final String wireName = r'MovieFileResource';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MovieFileResource object, {
  ...
  void _deserializeProperties(
    ...
    required MovieFileResourceBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'originalFilePath':
          ...
          if (valueDes == null) continue;
          result.originalFilePath = valueDes;
          break;
  ...
  @override
  MovieFileResource deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MovieFileResourceBuilder();
