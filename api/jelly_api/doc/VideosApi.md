...
final api = JellyApi().getVideosApi();
...
final api = JellyApi().getVideosApi();
final List<String> ids = ; // List<String> | Item id list. This allows multiple, comma delimited.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ids** | [**List&lt;String&gt;**](String.md)| Item id list. This allows multiple, comma delimited. | 
