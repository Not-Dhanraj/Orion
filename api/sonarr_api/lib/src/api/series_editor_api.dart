...
class SeriesEditorApi {
  ...
  const SeriesEditorApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiV3SeriesEditorDelete({
    ...
    try {
      const _type = FullType(SeriesEditorResource);
      _bodyData = seriesEditorResource == null
          ? null
          : _serializers.serialize(seriesEditorResource, specifiedType: _type);
