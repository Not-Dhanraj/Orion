...
abstract class _$SelectOptionCWProxy {
  ...
  SelectOption dividerAfter(bool? dividerAfter);
...
class _$SelectOptionCWProxyImpl implements _$SelectOptionCWProxy {
  ...
  SelectOption call({
    ...
    Object? dividerAfter = const $CopyWithPlaceholder(),
  }) {
    return SelectOption(
      ...
      hint: hint == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : hint as String?,
      dividerAfter: dividerAfter == const $CopyWithPlaceholder()
          ? _value.dividerAfter
          // ignore: cast_nullable_to_non_nullable
          : dividerAfter as bool?,
    );
  }
}
...
SelectOption _$SelectOptionFromJson(Map<String, dynamic> json) =>
    $checkedCreate('SelectOption', json, ($checkedConvert) {
      final val = SelectOption(
        ...
        dividerAfter: $checkedConvert('dividerAfter', (v) => v as bool?),
      );
      return val;
    });
...
Map<String, dynamic> _$SelectOptionToJson(SelectOption instance) =>
    <String, dynamic>{
      ...
      'hint': ?instance.hint,
      'dividerAfter': ?instance.dividerAfter,
    };
