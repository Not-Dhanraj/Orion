...
class SyncPlayGroupLeftUpdate {
  ...
  final GroupUpdateType? type;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is SyncPlayGroupLeftUpdate &&
  ...
  factory SyncPlayGroupLeftUpdate.fromJson(Map<String, dynamic> json) => _$SyncPlayGroupLeftUpdateFromJson(json);
