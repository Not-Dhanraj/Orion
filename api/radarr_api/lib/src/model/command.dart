...
abstract class Command implements Built<Command, CommandBuilder> {
  ...
  @BuiltValueField(wireName: r'isTypeExclusive')
  bool? get isTypeExclusive;
...
class _$CommandSerializer implements PrimitiveSerializer<Command> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.isTypeExclusive != null) {
      yield r'isTypeExclusive';
      yield serializers.serialize(
        object.isTypeExclusive,
        specifiedType: const FullType(bool),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'isExclusive':
          ...
          break;
        case r'isTypeExclusive':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.isTypeExclusive = valueDes;
          break;
