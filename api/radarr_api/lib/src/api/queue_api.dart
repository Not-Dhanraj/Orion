...
import 'package:radarr/src/model/queue_bulk_resource.dart';
import 'package:radarr/src/model/queue_resource_paging_resource.dart';
  ...
  Future<Response<QueueResourcePagingResource>> apiV3QueueGet({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (includeUnknownMovieItems != null)
        r'includeUnknownMovieItems': encodeQueryParameter(
            _serializers, includeUnknownMovieItems, const FullType(bool)),
