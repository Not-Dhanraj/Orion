...
class LibraryApi {
  ...
  Future<Response<LibraryOptionsResultDto>> getLibraryOptionsInfo({
    ...
    final _queryParameters = <String, dynamic>{
      if (libraryContentType != null) r'libraryContentType': libraryContentType,
      if (isNewLibrary != null) r'isNewLibrary': isNewLibrary,
    };
  ...
  Future<Response<AllThemeMediaResult>> getThemeMedia({
    ...
    final _queryParameters = <String, dynamic>{
      if (userId != null) r'userId': userId,
      if (inheritFromParent != null) r'inheritFromParent': inheritFromParent,
