...
class PluginInstallationFailedMessage {
  ...
  final SessionMessageType? messageType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PluginInstallationFailedMessage &&
      other.data == data &&
  ...
  factory PluginInstallationFailedMessage.fromJson(Map<String, dynamic> json) => _$PluginInstallationFailedMessageFromJson(json);

  Map<String, dynamic> toJson() => _$PluginInstallationFailedMessageToJson(this);
