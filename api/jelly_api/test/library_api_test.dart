...
void main() {
  final instance = JellyApi().getLibraryApi();
  ...
  group(LibraryApi, () {
    ...
    //
    //Future<AllThemeMediaResult> getThemeMedia(String itemId, { String userId, bool inheritFromParent, List<ItemSortBy> sortBy, List<SortOrder> sortOrder }) async
    ...
    //
    //Future<ThemeMediaResult> getThemeSongs(String itemId, { String userId, bool inheritFromParent, List<ItemSortBy> sortBy, List<SortOrder> sortOrder }) async
    ...
    //
    //Future<ThemeMediaResult> getThemeVideos(String itemId, { String userId, bool inheritFromParent, List<ItemSortBy> sortBy, List<SortOrder> sortOrder }) async
