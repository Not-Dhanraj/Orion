...
class MovieDetailsControllerNotifier extends StateNotifier<MovieResource> {
  ...
  MovieDetailsControllerNotifier(this._ref, this._movieService)
    : super(MovieResource());
  ...
  Future<void> deleteMovie({
    ...
    await _movieService.deleteMovie(
      state.id!,
      deleteFiles,
...
final movieDetailsController =
    StateNotifierProvider<MovieDetailsControllerNotifier, MovieResource>(
      (ref) =>
          MovieDetailsControllerNotifier(ref, ref.watch(movieServiceProvider)),
    );
