...
class TimerCancelledMessage {
  /// Returns a new [TimerCancelledMessage] instance.
  TimerCancelledMessage({
     ...
     this.messageType = SessionMessageType.timerCancelled,
  });
  ...
  final SessionMessageType? messageType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is TimerCancelledMessage &&
      other.data == data &&
  ...
  factory TimerCancelledMessage.fromJson(Map<String, dynamic> json) => _$TimerCancelledMessageFromJson(json);
