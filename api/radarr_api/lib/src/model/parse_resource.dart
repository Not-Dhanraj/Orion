...
import 'package:radarr/src/model/parsed_movie_info.dart';
...
abstract class ParseResource
  ...
  @BuiltValueField(wireName: r'parsedMovieInfo')
  ParsedMovieInfo? get parsedMovieInfo;
...
class _$ParseResourceSerializer implements PrimitiveSerializer<ParseResource> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.parsedMovieInfo != null) {
      yield r'parsedMovieInfo';
      yield serializers.serialize(
        object.parsedMovieInfo,
        specifiedType: const FullType(ParsedMovieInfo),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'title':
          ...
          break;
        case r'parsedMovieInfo':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ParsedMovieInfo),
          ) as ParsedMovieInfo;
          result.parsedMovieInfo.replace(valueDes);
          break;
        case r'movie':
          final valueDes = serializers.deserialize(
            value,
