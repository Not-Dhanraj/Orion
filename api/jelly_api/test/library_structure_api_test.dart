...
void main() {
  final instance = JellyApi().getLibraryStructureApi();
  ...
  group(LibraryStructureApi, () {
    ...
    //
    //Future addVirtualFolder({ String name, CollectionTypeOptions collectionType, List<String> paths, bool refreshLibrary, AddVirtualFolderDto addVirtualFolderDto }) async
