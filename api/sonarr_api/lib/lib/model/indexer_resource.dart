...
class IndexerResource {
  ...
  @JsonKey(
    ...
    name: r'seasonSearchMaximumSingleEpisodeAge',
    required: false,
    includeIfNull: false,
  )
  ...
  final int? downloadClientId;
    ...
    bool operator ==(Object other) => identical(this, other) || other is IndexerResource &&
      ...
      other.seasonSearchMaximumSingleEpisodeAge == seasonSearchMaximumSingleEpisodeAge &&
    ...
    int get hashCode =>
        ...
        protocol.hashCode +
        priority.hashCode +
        seasonSearchMaximumSingleEpisodeAge.hashCode +
