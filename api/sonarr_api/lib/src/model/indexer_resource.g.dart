...
class _$IndexerResource extends IndexerResource {
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, seasonSearchMaximumSingleEpisodeAge.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'IndexerResource')
          ...
          ..add('seasonSearchMaximumSingleEpisodeAge',
              seasonSearchMaximumSingleEpisodeAge)
...
class IndexerResourceBuilder
  ...
  int? _seasonSearchMaximumSingleEpisodeAge;
  int? get seasonSearchMaximumSingleEpisodeAge =>
      _$this._seasonSearchMaximumSingleEpisodeAge;
  set seasonSearchMaximumSingleEpisodeAge(
  ...
  IndexerResourceBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _seasonSearchMaximumSingleEpisodeAge =
          $v.seasonSearchMaximumSingleEpisodeAge;
