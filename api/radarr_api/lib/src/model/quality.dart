...
import 'package:radarr/src/model/modifier.dart';
import 'package:radarr/src/model/quality_source.dart';
...
abstract class Quality implements Built<Quality, QualityBuilder> {
  ...
  // enum source_Enum {  unknown,  cam,  telesync,  telecine,  workprint,  dvd,  tv,  webdl,  webrip,  bluray,  };
  ...
  // enum modifierEnum {  none,  regional,  screener,  rawhd,  brdisk,  remux,  };
...
class _$QualitySerializer implements PrimitiveSerializer<Quality> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.modifier != null) {
      ...
      yield serializers.serialize(
        object.modifier,
        specifiedType: const FullType(Modifier),
      );
    }
  }
