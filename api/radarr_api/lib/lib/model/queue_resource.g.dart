...
abstract class _$QueueResourceCWProxy {
  ...
  QueueResource movieId(int? movieId);

  QueueResource movie(MovieResource? movie);
...
class _$QueueResourceCWProxyImpl implements _$QueueResourceCWProxy {
  ...
  @override
  QueueResource movieId(int? movieId) => this(movieId: movieId);

  @override
  QueueResource movie(MovieResource? movie) => this(movie: movie);
