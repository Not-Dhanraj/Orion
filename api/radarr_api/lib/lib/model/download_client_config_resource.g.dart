...
abstract class _$DownloadClientConfigResourceCWProxy {
  ...
  DownloadClientConfigResource checkForFinishedDownloadInterval(
...
class _$DownloadClientConfigResourceCWProxyImpl
  ...
  DownloadClientConfigResource call({
    ...
    Object? checkForFinishedDownloadInterval = const $CopyWithPlaceholder(),
    ...
    return DownloadClientConfigResource(
      ...
      checkForFinishedDownloadInterval:
          checkForFinishedDownloadInterval == const $CopyWithPlaceholder()
          ? _value.checkForFinishedDownloadInterval
          // ignore: cast_nullable_to_non_nullable
          : checkForFinishedDownloadInterval as int?,
...
DownloadClientConfigResource _$DownloadClientConfigResourceFromJson(
  ...
  final val = DownloadClientConfigResource(
    ...
    checkForFinishedDownloadInterval: $checkedConvert(
      'checkForFinishedDownloadInterval',
      (v) => (v as num?)?.toInt(),
    ),
