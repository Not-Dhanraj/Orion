...
import 'package:radarr/src/model/calendar_release_type.dart';
...
class CalendarFeedApi {
  ...
  Future<Response<void>> feedV3CalendarRadarrIcsGet({
    ...
    BuiltList<CalendarReleaseType>? releaseTypes,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (releaseTypes != null)
        r'releaseTypes': encodeCollectionQueryParameter<CalendarReleaseType>(
          _serializers,
          releaseTypes,
          const FullType(BuiltList, [FullType(CalendarReleaseType)]),
