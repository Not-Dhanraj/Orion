...
import 'package:jelly_api/lib/model/channel_type.dart';
...
class LiveTvApi {
  ...
  Future<Response<ListingsProviderInfo>> addListingProvider({
    ...
    final _queryParameters = <String, dynamic>{
      if (pw != null) r'pw': pw,
      if (validateListings != null) r'validateListings': validateListings,
      if (validateLogin != null) r'validateLogin': validateLogin,
    };
  ...
  Future<Response<List<TunerHostInfo>>> discoverTuners({
    ...
    final _queryParameters = <String, dynamic>{
      if (newDevicesOnly != null) r'newDevicesOnly': newDevicesOnly,
    };
  ...
  Future<Response<BaseItemDtoQueryResult>> getLiveTvChannels({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (isLiked != null) r'isLiked': isLiked,
      if (isDisliked != null) r'isDisliked': isDisliked,
  ...
  Future<Response<BaseItemDtoQueryResult>> getLiveTvPrograms({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (userId != null) r'userId': userId,
      if (minStartDate != null) r'minStartDate': minStartDate,
      if (hasAired != null) r'hasAired': hasAired,
      if (isAiring != null) r'isAiring': isAiring,
      if (maxStartDate != null) r'maxStartDate': maxStartDate,
      if (minEndDate != null) r'minEndDate': minEndDate,
      if (maxEndDate != null) r'maxEndDate': maxEndDate,
      if (isMovie != null) r'isMovie': isMovie,
      if (isSeries != null) r'isSeries': isSeries,
      if (isNews != null) r'isNews': isNews,
      if (isKids != null) r'isKids': isKids,
  ...
  Future<Response<BaseItemDtoQueryResult>> getRecordings({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (isInProgress != null) r'isInProgress': isInProgress,
      if (seriesTimerId != null) r'seriesTimerId': seriesTimerId,
      if (enableImages != null) r'enableImages': enableImages,
      if (imageTypeLimit != null) r'imageTypeLimit': imageTypeLimit,
      if (enableImageTypes != null) r'enableImageTypes': enableImageTypes,
  ...
  Future<Response<TimerInfoDtoQueryResult>> getTimers({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (isScheduled != null) r'isScheduled': isScheduled,
    };
