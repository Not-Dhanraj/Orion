...
class AutoTaggingSpecificationSchema {
  /// Returns a new [AutoTaggingSpecificationSchema] instance.
  ...
  final List<Field>? fields;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is AutoTaggingSpecificationSchema &&
      other.id == id &&
      other.name == name &&
  ...
  factory AutoTaggingSpecificationSchema.fromJson(Map<String, dynamic> json) => _$AutoTaggingSpecificationSchemaFromJson(json);

  Map<String, dynamic> toJson() => _$AutoTaggingSpecificationSchemaToJson(this);
