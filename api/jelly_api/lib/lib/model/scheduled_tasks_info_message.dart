...
class ScheduledTasksInfoMessage {
  ...
  final SessionMessageType? messageType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ScheduledTasksInfoMessage &&
      other.data == data &&
  ...
  factory ScheduledTasksInfoMessage.fromJson(Map<String, dynamic> json) => _$ScheduledTasksInfoMessageFromJson(json);
