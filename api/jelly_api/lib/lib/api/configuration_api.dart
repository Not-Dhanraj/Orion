...
_responseData = rawData == null ? null : deserialize<ServerConfiguration, ServerConfiguration>(rawData, 'ServerConfiguration', growable: true);
  ...
  Future<Response<MetadataOptions>> getDefaultMetadataOptions({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MetadataOptions, MetadataOptions>(rawData, 'MetadataOptions', growable: true);
