...
abstract class HistoryResource
  ...
  MovieHistoryEventType? get eventType;
  // enum eventTypeEnum {  unknown,  grabbed,  downloadFolderImported,  downloadFailed,  movieFileDeleted,  movieFolderImported,  movieFileRenamed,  downloadIgnored,  };
...
class _$HistoryResourceSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.eventType != null) {
      ...
      yield serializers.serialize(
        object.eventType,
        specifiedType: const FullType(MovieHistoryEventType),
      );
    }
    if (object.data != null) {
      yield r'data';
