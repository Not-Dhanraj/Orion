...
# **apiV3EpisodeGet**
> List<EpisodeResource> apiV3EpisodeGet(seriesId, seasonNumber, episodeIds, episodeFileId, includeSeries, includeEpisodeFile, includeImages)
...
final api = SonarrApi().getEpisodeApi();
