...
final api = JellyApi().getPlaylistsApi();
final String playlistId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | The playlist id.
final List<String> ids = ; // List<String> | Item id, comma delimited.
 ...
 **ids** | [**List&lt;String&gt;**](String.md)| Item id, comma delimited. | [optional] 
...
final List<String> ids = ; // List<String> | The item ids.
 ...
 **ids** | [**List&lt;String&gt;**](String.md)| The item ids. | [optional] 
...
final api = JellyApi().getPlaylistsApi();
final String playlistId = playlistId_example; // String | The playlist id.
final List<String> entryIds = ; // List<String> | The item ids, comma delimited.
