...
// tests for AuthenticationInfo
void main() {
  final AuthenticationInfo? instance = /* AuthenticationInfo(...) */ null;
  // TODO add properties to the entity

  group(AuthenticationInfo, () {
    ...
    test('to test the property `dateRevoked`', () async {
      // TODO
    });
