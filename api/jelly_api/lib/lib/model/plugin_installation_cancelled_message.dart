...
class PluginInstallationCancelledMessage {
  ...
  final SessionMessageType? messageType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PluginInstallationCancelledMessage &&
      other.data == data &&
  ...
  factory PluginInstallationCancelledMessage.fromJson(Map<String, dynamic> json) => _$PluginInstallationCancelledMessageFromJson(json);

  Map<String, dynamic> toJson() => _$PluginInstallationCancelledMessageToJson(this);
