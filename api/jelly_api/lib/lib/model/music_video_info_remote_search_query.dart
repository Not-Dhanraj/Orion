...
class MusicVideoInfoRemoteSearchQuery {
  ...
  factory MusicVideoInfoRemoteSearchQuery.fromJson(Map<String, dynamic> json) => _$MusicVideoInfoRemoteSearchQueryFromJson(json);

  Map<String, dynamic> toJson() => _$MusicVideoInfoRemoteSearchQueryToJson(this);
