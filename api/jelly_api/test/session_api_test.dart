...
void main() {
  final instance = JellyApi().getSessionApi();
  ...
  group(SessionApi, () {
    ...
    //
    //Future<List<SessionInfoDto>> getSessions({ String controllableByUserId, String deviceId, int activeWithinSeconds }) async
    ...
    //
    //Future postCapabilities({ String id, List<MediaType> playableMediaTypes, List<GeneralCommandType> supportedCommands, bool supportsMediaControl, bool supportsPersistentIdentifier }) async
