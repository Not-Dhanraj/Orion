...
class DisplayPreferencesApi {
  ...
  const DisplayPreferencesApi(this._dio);
...
_responseData = rawData == null ? null : deserialize<DisplayPreferencesDto, DisplayPreferencesDto>(rawData, 'DisplayPreferencesDto', growable: true);
  ...
  Future<Response<void>> updateDisplayPreferences({ 
    ...
    try {
_bodyData=jsonEncode(displayPreferencesDto);
    } catch(error, stackTrace) {
      throw DioException(
