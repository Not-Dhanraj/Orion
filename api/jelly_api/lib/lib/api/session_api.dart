...
class SessionApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<NameIdPair>>> getAuthProviders({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<List<NameIdPair>, NameIdPair>(rawData, 'List<NameIdPair>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [List<NameIdPair>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<NameIdPair>>> getPasswordResetProviders({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<List<NameIdPair>, NameIdPair>(rawData, 'List<NameIdPair>', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<SessionInfoDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<SessionInfoDto>>> getSessions({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (controllableByUserId != null) r'controllableByUserId': controllableByUserId,
      if (deviceId != null) r'deviceId': deviceId,
      if (activeWithinSeconds != null) r'activeWithinSeconds': activeWithinSeconds,
    };
    ...
    List<SessionInfoDto>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<SessionInfoDto>, SessionInfoDto>(rawData, 'List<SessionInfoDto>', growable: true);
    ...
    return Response<List<SessionInfoDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> postCapabilities({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (id != null) r'id': id,
      if (playableMediaTypes != null) r'playableMediaTypes': playableMediaTypes,
      if (supportedCommands != null) r'supportedCommands': supportedCommands,
      if (supportsMediaControl != null) r'supportsMediaControl': supportsMediaControl,
      if (supportsPersistentIdentifier != null) r'supportsPersistentIdentifier': supportsPersistentIdentifier,
    };
  ...
  Future<Response<void>> postFullCapabilities({ 
    ...
    try {
_bodyData=jsonEncode(clientCapabilitiesDto);
    } catch(error, stackTrace) {
      throw DioException(
  ...
  Future<Response<void>> sendFullGeneralCommand({ 
    ...
    try {
_bodyData=jsonEncode(generalCommand);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<void>> sendMessageCommand({ 
    ...
    try {
_bodyData=jsonEncode(messageCommand);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<void>> sendPlaystateCommand({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (seekPositionTicks != null) r'seekPositionTicks': seekPositionTicks,
      if (controllingUserId != null) r'controllingUserId': controllingUserId,
    };
