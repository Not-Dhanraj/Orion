...
void main() {
  final instance = JellyApi().getUserLibraryApi();
  ...
  group(UserLibraryApi, () {
    ...
    //
    //Future<List<BaseItemDto>> getLocalTrailers(String itemId, { String userId }) async
    ...
    //
    //Future<List<BaseItemDto>> getSpecialFeatures(String itemId, { String userId }) async
