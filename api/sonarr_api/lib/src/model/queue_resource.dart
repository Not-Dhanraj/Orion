...
abstract class QueueResource
  ...
  @BuiltValueField(wireName: r'episodeHasFile')
  bool? get episodeHasFile;
...
class _$QueueResourceSerializer implements PrimitiveSerializer<QueueResource> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.episodeHasFile != null) {
      yield r'episodeHasFile';
      yield serializers.serialize(
        object.episodeHasFile,
        specifiedType: const FullType(bool),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'outputPath':
          ...
          break;
        case r'episodeHasFile':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.episodeHasFile = valueDes;
          break;
        case r'sizeleft':
          final valueDes = serializers.deserialize(
            value,
