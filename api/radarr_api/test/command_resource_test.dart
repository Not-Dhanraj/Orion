...
void main() {
  final CommandResource? instance = /* CommandResource(...) */ null;
  // TODO add properties to the entity

  group(CommandResource, () {
    // int id
    ...
    // String commandName
    test('to test the property `commandName`', () async {
      // TODO
    });
    ...
    test('to test the property `stateChangeTime`', () async {
      // TODO
    });
