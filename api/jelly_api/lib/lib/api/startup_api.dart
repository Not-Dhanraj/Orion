...
_responseData = rawData == null ? null : deserialize<StartupUserDto, StartupUserDto>(rawData, 'StartupUserDto', growable: true);
...
_responseData = rawData == null ? null : deserialize<StartupUserDto, StartupUserDto>(rawData, 'StartupUserDto', growable: true);
  ...
  Future<Response<StartupConfigurationDto>> getStartupConfiguration({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<StartupConfigurationDto, StartupConfigurationDto>(rawData, 'StartupConfigurationDto', growable: true);
  ...
  Future<Response<void>> setRemoteAccess({ 
    ...
    try {
_bodyData=jsonEncode(startupRemoteAccessDto);
    } catch(error, stackTrace) {
      throw DioException(
  ...
  Future<Response<void>> updateInitialConfiguration({ 
    ...
    try {
_bodyData=jsonEncode(startupConfigurationDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<void>> updateStartupUser({ 
    ...
    try {
_bodyData=jsonEncode(startupUserDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
