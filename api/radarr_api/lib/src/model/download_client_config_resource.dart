...
abstract class DownloadClientConfigResource
  ...
  @BuiltValueField(wireName: r'checkForFinishedDownloadInterval')
...
class _$DownloadClientConfigResourceSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.checkForFinishedDownloadInterval != null) {
      yield r'checkForFinishedDownloadInterval';
      yield serializers.serialize(
        object.checkForFinishedDownloadInterval,
        specifiedType: const FullType(int),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'enableCompletedDownloadHandling':
          ...
          break;
        case r'checkForFinishedDownloadInterval':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          ) as int;
          result.checkForFinishedDownloadInterval = valueDes;
          break;
