...
class FileDateType extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'localAirDate')
  static const FileDateType localAirDate = _$localAirDate;
  @BuiltValueEnumConst(wireName: r'utcAirDate')
  static const FileDateType utcAirDate = _$utcAirDate;
