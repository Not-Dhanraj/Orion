...
abstract class TagDetailsResource
  ...
  @BuiltValueField(wireName: r'releaseProfileIds')
  BuiltList<int>? get releaseProfileIds;
...
class _$TagDetailsResourceSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.releaseProfileIds != null) {
      yield r'releaseProfileIds';
      yield serializers.serialize(
        object.releaseProfileIds,
        specifiedType: const FullType.nullable(BuiltList, [FullType(int)]),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'notificationIds':
          ...
          break;
        case r'releaseProfileIds':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(int)]),
          ) as BuiltList<int>?;
          if (valueDes == null) continue;
          result.releaseProfileIds.replace(valueDes);
          break;
        case r'indexerIds':
          final valueDes = serializers.deserialize(
            value,
