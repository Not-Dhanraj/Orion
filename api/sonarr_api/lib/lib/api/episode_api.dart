...
class EpisodeApi {
  ...
  Future<Response<List<EpisodeResource>>> apiV3EpisodeGet({ 
    int? seriesId,
    int? seasonNumber,
    List<int>? episodeIds,
    int? episodeFileId,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (episodeFileId != null) r'episodeFileId': episodeFileId,
...
_responseData = rawData == null ? null : deserialize<List<EpisodeResource>, EpisodeResource>(rawData, 'List<EpisodeResource>', growable: true);
  ...
  Future<Response<EpisodeResource>> apiV3EpisodeIdGet({ 
    ...
    final _path = r'/api/v3/episode/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<EpisodeResource, EpisodeResource>(rawData, 'EpisodeResource', growable: true);
  ...
  Future<Response<EpisodeResource>> apiV3EpisodeIdPut({ 
    ...
    try {
_bodyData=jsonEncode(episodeResource);
    } catch(error, stackTrace) {
      throw DioException(
...
_responseData = rawData == null ? null : deserialize<EpisodeResource, EpisodeResource>(rawData, 'EpisodeResource', growable: true);
  ...
  Future<Response<void>> apiV3EpisodeMonitorPut({ 
    ...
    try {
_bodyData=jsonEncode(episodesMonitoredResource);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
